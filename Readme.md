...
# Configuration Script – CNE-1.3 - Rev. A

This **Configuration** script is designed for the **CNE-1.3** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – CNE-1.3 Rev. A

Este script de **Configuration** está diseñado para el modelo **CNE-1.3** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
